export const homePt = {
  ...
  hero: {
    eyebrow: "Diário de energia emocional com IA",
    title: "Seu segundo cérebro emocional.",
    body: "A EmotiveCare entende o que você escreve, conecta seus padrões ao longo do tempo e devolve reflexões feitas para a sua história — não respostas prontas.",
    quote: "Ele sente com você e lembra por você.",
    ctaPrimary: "Começar grátis",
    ctaSecondary: "Ver como funciona",
    trustLine: "Grátis para começar · Sem cartão · Seus dados são seus (LGPD)",
    tagline: "Seu segundo cérebro emocional. Ele sente com você e lembra por você.",
  },
  howItWorks: {
    title: "Como a EmotiveCare funciona",
    subtitle:
      "Do registro do momento à reflexão personalizada — em quatro passos simples.",
    steps: [
      {
        step: "1",
  ...
  secondBrain: {
    eyebrow: "O diferencial da EmotiveCare",
    title: "Um diário comum esquece. A EmotiveCare lembra.",
    bodyBefore: "A maioria dos apps guarda seus textos e os deixa soltos, um dia sem falar com o outro. A EmotiveCare organiza suas emoções por",
    bodyEmphasis: "significado",
    bodyAfter:
      ", não por data. Quando você conversa com o assistente, ele busca no seu histórico — com memória semântica — os momentos parecidos com o de agora e conecta pontos que até você já tinha esquecido.",
    ordinaryLabel: "Um diário comum",
    ordinaryText:
      "Você registra que está ansioso hoje. O texto é salvo, isolado — e ninguém liga esse dia a nenhum outro. Semana que vem, você começa do zero.",
  ...
  security: {
    ...
    subtitle: "Transparência sobre o que a EmotiveCare é — e o que ele não é.",
    items: [
      {
