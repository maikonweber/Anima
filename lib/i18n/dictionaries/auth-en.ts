...
export const authEn = {
  ...
  resetPassword: {
    ...
    invalidToken: "Invalid or expired link. Please request a new one.",
    errors: {
      passwordTooShort: "Password must be at least 6 characters.",
      passwordMismatch: "Passwords do not match.",
      failed: "Could not reset the password. Please try again.",
    },
  },
  verifyEmail: {
    title: "Verify email",
    ...
    failed: "Could not verify the email. The link may have expired.",
    goLogin: "Go to sign in",
  },
  awaitingVerification: {
    title: "Confirm your email",
    body: "We sent a verification link to your email. Open it to activate your account.",
    resend: "Resend email",
    resent: "Email resent.",
    logout: "Sign out",
    goLogin: "Go to sign in",
